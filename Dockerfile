#NU ESTE VARIANTA FINALA DE DOCKER #
#De editat mai tarziu celelalte misiuni, de exemplu de completat pana la 25 
...
# userul tehnic "student" - doar owner pentru fisierul-tinta din M02, asa era cerinta
...
# ruleaza fiecare misiune (unele depind de userii creati anterior
